...
public class Recipes {
	...
	private void deleteRecipe() {
		...
		if (Objects.nonNull(recipeId)) {
			...
			System.out.println("\n*** You have deleted recipe " + recipeId + " ***");
			 // If the deleted recipe is the current recipe, reset the current recipe to null.
	...
	private void displayRecipe(Recipe recipe) {
		...
		System.out.println("Description: " + recipe.getNotes());
		System.out.println("Prep Time: " + recipe.getPrepTime() + " minutes");
		System.out.println("Cook Time: " + recipe.getCookTime() + " minutes");
		...
		for (Ingredient ingredient : recipe.getIngredients()) {
			...
			if (amount == null) {
				System.out.println("  - " + ingredient.getIngredientName() + ": null");
			...
			if (unit != null) {
				...
				if (amount.compareTo(one) == 0) {
					unitName = unit.getUnitNameSingular() != null ? unit.getUnitNameSingular() : "";
				} else {
					unitName = unit.getUnitNamePlural() != null ? unit.getUnitNamePlural() : "";
				}
			}
			// Check if the amount is a whole number
			if (amount.setScale(0, RoundingMode.DOWN).compareTo(amount) == 0) {
				System.out.println("  - " + ingredient.getIngredientName() + ": " + amount.intValue() + " " + unitName);
			} else {
				System.out.println("  - " + ingredient.getIngredientName() + ": " + amount + " " + unitName);
			}
		}
	...
	private int getOperation() {
		printOperations();
		Integer op = getIntInput("\nEnter an operation number or press Enter to quit");
